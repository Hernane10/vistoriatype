...
import type { Imovel, Inspection } from "../types/inspection";
...
export function enderecoCompleto(imovel: Imovel | null | undefined): string {
  if (!imovel) return "";
...
export function fichaText(inspection: Inspection): string {
  return [
